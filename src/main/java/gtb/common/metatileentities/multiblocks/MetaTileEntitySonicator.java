...
public class MetaTileEntitySonicator extends RecipeMapMultiblockController {
    ...
    public MetaTileEntitySonicator(ResourceLocation metaTileEntityId) {
        super(metaTileEntityId, GTBRecipeMaps.SONICATOR_RECIPES);
    }

    public IBlockState getCasingState() {
        return GTBMetaBlocks.GTB_MULTIBLOCK_CASING2.getState(GTBMultiblockCasing2.CasingType.SONCIATOR_CASING);
    }
    ...
    protected @NotNull BlockPattern createStructurePattern() {
        return FactoryBlockPattern.start(RelativeDirection.RIGHT, RelativeDirection.BACK, RelativeDirection.UP)
                ...
                .where('~', any())
                .where('X', states(getCasingState()).setMinGlobalLimited(90)
                        .or(autoAbilities()))
    ...
    public ICubeRenderer getBaseTexture(IMultiblockPart sourcePart) {
        return GTBTextures.SONCIATOR_CASING;
    }
