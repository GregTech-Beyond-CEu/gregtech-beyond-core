...
public class MetaTileEntityElectricArcFurnace extends RecipeMapMultiblockController {

    public MetaTileEntityElectricArcFurnace(ResourceLocation metaTileEntityId) {
        super(metaTileEntityId, GTBRecipeMaps.ELECTRIC_ARC_FURNACE_RECIPES);
    }

    public IBlockState getCasingState() {
        return GTBMetaBlocks.GTB_MULTIBLOCK_CASING3.getState(GTBMultiblockCasing3.CasingType.ELECTRIC_ARC_FURNACE_CASING);
    }
    ...
    protected @NotNull BlockPattern createStructurePattern() {
        return FactoryBlockPattern.start(RelativeDirection.RIGHT, RelativeDirection.BACK, RelativeDirection.UP)
                ...
                .where('Z', states(GTBMetaBlocks.GTB_MULTIBLOCK_CASING2.getState(GTBMultiblockCasing2.CasingType.ARC_FURNACE_ELECTRODE_BLOCK)))
                .build();
    }
    ...
    public ICubeRenderer getBaseTexture(IMultiblockPart sourcePart) {
        return GTBTextures.ELECTRIC_ARC_FURNACE_CASING_OVERLAY;
    }
