...
public class MetaTileEntityCZPuller extends RecipeMapMultiblockController {

    public MetaTileEntityCZPuller(ResourceLocation metaTileEntityId) {
        super(metaTileEntityId, GTBRecipeMaps.CZ_PULLER_RECIPES);
    }
    ...
    protected @NotNull BlockPattern createStructurePattern() {
        return FactoryBlockPattern.start(RelativeDirection.RIGHT, RelativeDirection.UP, RelativeDirection.BACK)
                ...
                .where('O', states(GTBMetaBlocks.GTB_MULTIBLOCK_CASING3.getState(GTBMultiblockCasing3.CasingType.MOLD_CASING)))
                .build();
    }
    ...
    protected ICubeRenderer getFrontOverlay() {
        return GTBTextures.CZ_PULLER_OVERLAY;
    }
