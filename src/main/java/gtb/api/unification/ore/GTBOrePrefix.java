...
public class GTBOrePrefix {
    ...
    public static final OrePrefix itemCasing = new OrePrefix("item_casing", M / 2, null, GTBMaterialIconType.itemCasing,
            OrePrefix.Flags.ENABLE_UNIFICATION, mat -> mat.hasFlag(GENERATE_ITEM_CASING));

    public static final OrePrefix seedCrystal = new OrePrefix("seed_crystal", -1, null, GTBMaterialIconType.seedCrystal,
            OrePrefix.Flags.ENABLE_UNIFICATION, mat -> !mat.hasFlag(DISABLE_SEED_CRYSTAL) &&  (mat.hasProperty(PropertyKey.GEM) || mat.hasFlag(GENERATE_SEED_CRYSTAL)));
    ...
    public static final OrePrefix boule = new OrePrefix("boule", -1, null, GTBMaterialIconType.boule,
            OrePrefix.Flags.ENABLE_UNIFICATION, mat -> !mat.hasFlag(DISABLE_BOULE) && (mat.hasProperty(PropertyKey.GEM) || mat.hasFlag(GENERATE_BOULE)));
    ...
    public static final OrePrefix pellets = new OrePrefix("pellets", M, null, GTBMaterialIconType.pellets,
            OrePrefix.Flags.ENABLE_UNIFICATION, mat -> mat.hasFlag(GENERATE_PELLETS));
    ...
    public static void register() {
        ...
        MetaItems.addOrePrefix(GTBOrePrefix.pellets);
    }
}
